...
const ActivityCard: React.FC<ActivityCardProps> = ({ name, description }) => {
  return (
    <div className='p-2 border border-white/20 rounded-2xl space-y-4 hover:border-white/50
    transition bg-gradient-to-b from-transparent to-white/5'>
      ...
      <div className="space-y-2 px-2 pb-2">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-lg font-secondary font-semibold text-white">{name}</h3>
        </div>
